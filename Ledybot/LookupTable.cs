            ...
            switch (species)
            {
                ...
                case 745:
                    switch (forme)
                    {
                        ...
                        case 2: return new int[] { 181, 181, 181 }; // Dusk Form Lycanroc
                ...
                case 800:
                    switch (forme)
                    {
                        case 1: return new int[] { 232, 232, 232 }; // Dusk Form Necrozma
                        case 2: return new int[] { 232, 232, 232 }; // Dawn Form Necrozma
                        case 3: return new int[] { 233, 233, 233 }; // Ultra Form Necrozma
                        default: return new int[] { 232, 232, 232 }; // Normal Form Necrozma
                    }
                case 801: return new int[] { 220, 220, 220 }; // Magearna
                case 802: return new int[] { 101, 101, 101 }; // Marshadow
                case 803: return new int[] { 224, 224, 224 }; // Poipole
                case 804: return new int[] { 224, 224, 224 }; // Naganadel
                case 805: return new int[] { 224, 224, 224 }; // Stakataka
                case 806: return new int[] { 224, 224, 224 }; // Blacephalon
                case 807: return new int[] { 10, 10, 10 }; // Zeraora
                default: return new int[] { 0, 0, 0 }; // No pokémon
